...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (mmm-jinja2 js2-mode matlab-mode latex-pretty-symbols latex-preview-pane icicles yaml-mode virtualenvwrapper swiper nim-mode jedi haskell-mode flycheck-color-mode-line elpy caml)))
